    ...
    () =>
      language === 'ar'
        ? {
            ...
            lead: 'اضبط رابط تضمين لوحة Agro Cloud Dashboard. يُخزَّن في المتصفح فقط.',
        ...
        : {
            ...
            lead: 'Set the embed URL for the Agro Cloud Dashboard page. Stored in your browser only.',
