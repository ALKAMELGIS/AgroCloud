...
export const HYDRO_REPORT_MAP_SPECS: HydroMapSnapshotSpec[] = [
  ...
  { id: 'contours', title: 'Elevation Contour Map', subtitle: 'High, low, interval, and index contours', stepId: 'contours', kind: 'step' },
  ...
  { id: 'basins', title: 'Drainage Basins Map', subtitle: 'Largest sub-basins within AOI', stepId: 'basins', kind: 'step' },
