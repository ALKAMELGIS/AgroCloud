...
export const HYDRO_REPORT_MAP_SPECS: HydroMapSnapshotSpec[] = [
  ...
  { id: 'contours', title: 'Elevation Contour Map', subtitle: 'Blue→red by elevation Range · index contours emphasized', stepId: 'contours', kind: 'step' },
  { id: 'slope', title: 'Slope Analysis Map', stepId: 'slope', kind: 'step' },
  { id: 'aspect', title: 'Aspect Analysis Map', derived: 'aspect', kind: 'derived' },
  { id: 'flow-direction', title: 'Flow Direction Map', subtitle: 'ESRI D8 · arrow colours by cardinal direction', stepId: 'flow-direction', derived: 'flow-direction', kind: 'step' },
  ...
  { id: 'basins', title: 'Drainage Basins Map', subtitle: 'Primary basins · coordinated colours · area in legend', stepId: 'basins', kind: 'step' },
  { id: 'flood-risk', title: 'Flood Risk Assessment Map', subtitle: 'Low→Critical · high-contrast classes on imagery', derived: 'flood-risk', kind: 'derived' },
