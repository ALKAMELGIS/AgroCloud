...
/** Preserved shared kinds — CHAS alert system only. */
export type AgroCompositeRampKind = 'alert' | 'alert_delta' | `unique:${string}`
...
> = {
  CHAS: {
    ...
    labels: ALERT_CLASS_LABELS,
    subtitle: 'Crop Health Analysis Score · 🔴 critical → 🟢 healthy',
  },
  DCHAS: {
    kind: 'alert_delta',
    valueMin: -0.4,
